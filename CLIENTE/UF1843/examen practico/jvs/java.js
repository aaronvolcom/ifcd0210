...
function cambiarColores(z){
	...
	if (z%2==0){
		for (i=0;i< todos.length; i++){
			...
			todos[i].style.color = "#CBC126";
			document.getElementById('e').src="img/logoam.png";
		}
	}
		...
		for (i=0;i<todosFijo.length; i++){
			...
			document.getElementById('e').src="img/logo blanc.png";
		}
	}
	this.z=z+1;
	return this.z;
...
function cambiarFondo(h){
	var todos = document.getElementsByTagName('*');
	const todosFijo = document.getElementsByTagName('*');
	const repro = document.getElementById('player');
	var i;
	if (h%2==0){
		for (i=0;i< todos.length; i++){
			todos[i].style.backgroundImage="none";
			todos[i].style.backgroundColor="white";
			todos[i].style.color = "black";
           	document.getElementById('e').src="img/logoneg.png";
		}
	}
		...
		for (i=0;i<todosFijo.length; i++){
			todos[i].style=todosFijo[i].style;
			document.getElementById('e').src="img/logoblanc.png";
		}
	}
	this.h=h+1;
	return this.h;
